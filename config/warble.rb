...
Warbler::Config.new do |config|
  ...
  config.includes = FileList["appengine-web.xml", "datastore-indexes.xml", "music_stand.rb"]
  ...
  config.dirs = %w(music_stand views)
  # Additional files/directories to include, above those in config.dirs
  # config.includes = FileList["music_stand.rb"]
